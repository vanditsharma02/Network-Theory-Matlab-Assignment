...
for j= 1:10000
    ...
    n4 = (B(3)*B(6)*B(5)*B(2))+(B(6)*B(3)*B(1)*B(4))+(B(5)*B(2)*B(1)*B(4))+(B(2)*B(6)*B(4)*B(1));
    n2 = (B(6)*B(3))+(B(5)*B(2))+(B(2)*B(6))+(B(1)*B(4));
    n0 = 1;
    d5 = (B(3)*B(6)*B(5)*B(2)*B(4))+(B(6)*B(3)*B(5)*B(1)*B(4));
    d3 = (B(6)*B(3)*B(4))+(B(5)*B(2)*B(4))+(B(2)*B(6)*B(4))+(B(5)*B(1)*B(4))+(B(6)*B(1)*B(4))+(B(6)*B(3)*B(5));
    d1 = B(4)+B(5)+B(6);
...
hist(F,100);
xlim([0 1.6]);
title('POLE SENSITIVITY ANALYSIS - FOSTER II + CAUER I');
